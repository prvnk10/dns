...
<!--  <a href='faculty_profile.php?u=3' class="col-sm-8 list-group-item"> Progress Report </a>  -->
  <a href='faculty_profile.php?u=4' class="col-sm-8 list-group-item"> Attendance List </a>
...
<!--  <a href="faculty_profile.php?u=8" class="col-sm-8 list-group-item try"> Assignments </a> -->

  <a href="#assignments_content" class="col-sm-8 list-group-item" data-toggle="collapse"> Assignments </a>
  <ul id="assignments_content" class="collapse text-left divi col-sm-12">
    <ul>
      <li> <a href="faculty_profile.php?u=8" class="col-sm-12 list-group-item"> Upload Assignments </a> </li>
      <li> <a href="faculty_profile.php?u=11" class="col-sm-12 list-group-item"> Assign assignments </a> </li>
    </ul>
  </ul>

<!--
  <div class="dropdown col-sm-8 list-group-item">
